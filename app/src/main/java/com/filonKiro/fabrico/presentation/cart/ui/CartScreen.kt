                ...
                Box(
                    ...
                    if(offsetX <= -threshold) {
                        ...
                        Box (
                            modifier = Modifier
                                .fillMaxHeight()
                                .background(Color(context.getColor(R.color.gray)))
                                .padding(16.dp),
                            contentAlignment = Alignment.CenterEnd
                        ){
                            Icon(
                                painter = painterResource(id = R.drawable.icon_delete_fabrico),
                        ...
                        modifier = Modifier
                            ...
                            .pointerInput(Unit) {
                                detectHorizontalDragGestures { _, dragAmount ->
                                    ...
                                    offsetX = if (dragAmount < 0) {
                                        (offsetX + dragAmount).coerceAtLeast(-threshold)
                                    } else {
                                        (offsetX + dragAmount).coerceAtMost(0f)
                                    }
                                }
                            }
                            .animateContentSize()
